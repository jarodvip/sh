  ...
  while true; do
		  ...
		  case $sub_choice in
			  ...
			  15)
				  ...
				  send_stats "국가 허용$country_code 的IP"
				  ;;
			  16)
...
moltbot_menu() {
	...
	install_plugin() {
		...
		while true; do
			...
			echo "@openclaw/nostr # Nostr 프로토콜: 개인 정보 보호 및 보안 암호화된 채팅"
...
while true; do
	...
	if [ -z "$sub_choice" ]; then
	  ...
	  echo -e "${gl_kjlan}25.  ${color25}Nextcloud网盘                       ${gl_kjlan}26.  ${color26}QD-Today 예약된 작업 관리 프레임워크"
